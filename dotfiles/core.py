...
from .plans import AddPlan, EjectPlan, MovePlan
from .vcs import RepoPath, find_enclosing_vcs, git_add, is_ignored_by_vcs
...
def execute_add(plan: AddPlan, *, dry_run: bool = False) -> AddResult:
    ...
    if plan.already_tracked or plan.already_staged or dry_run:
        return AddResult(plan=plan, executed=False)  # TODO: improve returns
